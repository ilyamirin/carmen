...
(deftest index-basic-operations-test
  (testing "Index operations test."
    ...
    (let [key (create-and-fill-buffer 16)
      ...
      (is (= (get-memory-state memory) {:index-size 0 :free-cells 0})))))
